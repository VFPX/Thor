...
lcAppName       = 'Control Renamer'
	&& the name of the project
lcAppID         = 'ControlRenamer'
	&& similar to lcAppName but must be URL-friendly (no spaces or other
	&& illegal URL characters)
lcRepositoryURL = 'https://github.com/VFPX/ControlRenamerBuilder'
...
Control Renamer (Builder)

Project Manager: Tamar E. Granor

Control Renamed is a tool, usable as a builder, that lets you change the names of controls in a form, and update the code (in the form) that refers to them as you do. 
endtext
return lcNotes
