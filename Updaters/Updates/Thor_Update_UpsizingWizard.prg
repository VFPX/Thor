...
lcAppName       = 'Upsizing Wizard'
	&& the name of the project
lcAppID         = 'UpsizingWizard'
	&& similar to lcAppName but must be URL-friendly (no spaces or other
	&& illegal URL characters)
lcRepositoryURL = 'https://github.com/VFPX/UpsizingWizard'
...
with toUpdateObject
	...
	.Component            = 'Yes'
	.VersionLocalFilename = 'Upsizing WizardVersionFile.txt'
...
This is an update to the Visual FoxPro 9.0 SP2 Upsizing Wizard.
endtext
return lcNotes
